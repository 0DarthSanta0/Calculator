(function () {
    ...
    1: [function (require, module, exports) {
        ...
        function doGlobalOperation() {
            try {
                const number1 = new bigDecimal(document.getElementById('number1').value.split('').filter(el => el !== ' ').join('').replace(',','.'));
                const number2 = new bigDecimal(document.getElementById('number2').value.split('').filter(el => el !== ' ').join('').replace(',','.'));
                const number3 = new bigDecimal(document.getElementById('number3').value.split('').filter(el => el !== ' ').join('').replace(',','.'));
                const number4 = new bigDecimal(document.getElementById('number4').value.split('').filter(el => el !== ' ').join('').replace(',','.'));
                            ...
                            217:
                                (function (__unused_webpack_module, exports) {
                                    ...
                                    function compliment(number) {
                                        var s = '', l = number.length, dec = number.split('.')[1],
                                            ld = dec ? dec.length : 0;
                                        for (var i = 0; i < l; i++) {
                                ...
                                (function (module, __unused_webpack_exports, __webpack_require__) {
                                    ...
                                    var bigDecimal = /** @class */ (function () {
                                        ...
                                        bigDecimal.round = function (number, precision, mode) {
                                            ...
                                            if (mode === void 0) {
                                                mode = roundingModes_1.RoundingModes.HALF_EVEN;
                                            }
                                            number = bigDecimal.validate(number);
                                            if (isNaN(precision))
